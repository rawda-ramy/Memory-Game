...
// Programe Audio
let clickAudio = new Audio("/static/audio/click-sound.mp3"),
trueAudio = new Audio("/static/audio/true-answer.mp3"),
falseAudio = new Audio("/static/audio/false-answer.mp3"),
endingGameAudio = new Audio("/static/audio/ending-game-sound"),
startGameAudio = new Audio("/static/audio/starting-game-sound.mp3"),
playAgainAudio = new Audio("/static/audio/play-again-sound"),
memoryGameaudio = new Audio("/static/audio/memory_game_sound.mp3");
...
fruitStyle.addEventListener("click", () => {
  styleSheet.setAttribute("href", "/static/style-01.css");
  memoryGameaudio = new Audio("/static/audio/fruit music.mp3");
  menu.style.display = "none";

  image1.forEach((img) => {
    img.nextElementSibling.setAttribute("src", "/static/Images/style-01/grapes.jpg");
  });

  image2.forEach((img) => {
    img.nextElementSibling.setAttribute("src", "/static/Images/style-01/banana.jpg");
  });

  image3.forEach((img) => {
    img.nextElementSibling.setAttribute("src", "/static/Images/style-01/avocado.jfif");
  });

  image4.forEach((img) => {
    img.nextElementSibling.setAttribute(
      "src",
      "/static/Images/style-01/blue berry.jpg"
    );
  });

  image5.forEach((img) => {
    img.nextElementSibling.setAttribute("src", "/static/Images/style-01/orange.jpg");
  });

  image6.forEach((img) => {
    img.nextElementSibling.setAttribute("src", "/static/Images/style-01/appel.jpeg");
  });
});
...
winterStyle.addEventListener("click", () => {
  styleSheet.setAttribute("href", "/static/style-02.css");
  memoryGameaudio = new Audio("/static/audio/winter music.wav");
  menu.style.display = "none";

  image1.forEach((img) => {
    img.nextElementSibling.setAttribute(
      "src",
      "/static/Images/style-02/winter love.jpg"
    );
  });
  ...
  image2.forEach((img) => {
    img.nextElementSibling.setAttribute(
      "src",
      "/static/Images/style-02/winter festival.webp"
    );
  });
  ...
  image3.forEach((img) => {
    img.nextElementSibling.setAttribute(
      "src",
      "/static/Images/style-02/winter snowman.jpg"
    );
  });
  ...
  image4.forEach((img) => {
    img.nextElementSibling.setAttribute(
      "src",
      "/static/Images/style-02/winter view.jpg"
    );
  });
  ...
  image5.forEach((img) => {
    img.nextElementSibling.setAttribute(
      "src",
      "/static/Images/style-02/winter drink.jpg"
    );
  });
  ...
  image6.forEach((img) => {
    img.nextElementSibling.setAttribute(
      "src",
      "/static/Images/style-02/winter wolf.jpg"
    );
  });

  endingVideo.setAttribute(
    "src",
    "/static/Images/style-02/winter ending background.mp4"
  );
});
...
desertStyle.addEventListener("click", () => {
  styleSheet.setAttribute("href", "/static/style-03.css");
  memoryGameaudio = new Audio("/static/audio/desert misic.m4a");
  menu.style.display = "none";

  image1.forEach((img) => {
    img.nextElementSibling.setAttribute("src", "/static/Images/style-03/cactus.jpg");
  });

  image2.forEach((img) => {
    img.nextElementSibling.setAttribute("src", "/static/Images/style-03/camels.jpg");
  });

  image3.forEach((img) => {
    img.nextElementSibling.setAttribute("src", "/static/Images/style-03/safari.jpg");
  });

  image4.forEach((img) => {
    img.nextElementSibling.setAttribute(
      "src",
      "/static/Images/style-03/desert night.jfif"
    );
  });
  ...
  image5.forEach((img) => {
    img.nextElementSibling.setAttribute(
      "src",
      "/static/Images/style-03/desert cars.jpg"
    );
  });
  image6.forEach((img) => {
    img.nextElementSibling.setAttribute(
      "src",
      "/static/Images/style-03/desert camping.jpg"
    );
  });

  endingVideo.setAttribute(
    "src",
    "/static/Images/style-03/desert ending background.mp4"
  );
});
...
ancientLandmarksstyle.addEventListener("click", () => {
  styleSheet.setAttribute("href", "/static/style-04.css");
  memoryGameaudio = new Audio("/static/audio/ancient music.mp3");
  menu.style.display = "none";

  image1.forEach((img) => {
    img.nextElementSibling.setAttribute("src", "/static/Images/style-04/sphinx.jpg");
  });

  image2.forEach((img) => {
    img.nextElementSibling.setAttribute(
      "src",
      "/static/Images/style-04/liberty statue.jpeg"
    );
  });

  image3.forEach((img) => {
    img.nextElementSibling.setAttribute("src", "/static/Images/style-04/big ben.jpg");
  });

  image4.forEach((img) => {
    img.nextElementSibling.setAttribute(
      "src",
      "/static/Images/style-04/effil tower.jpg"
    );
  });
  ...
  image5.forEach((img) => {
    img.nextElementSibling.setAttribute(
      "src",
      "/static/Images/style-04/khalifa tower.jpg"
    );
  });
  image6.forEach((img) => {
    img.nextElementSibling.setAttribute("src", "/static/Images/style-04/greak.jpg");
  });

  endingVideo.setAttribute(
    "src",
    "/static/Images/style-04/ancient landmarks ending background.mp4"
  );
});